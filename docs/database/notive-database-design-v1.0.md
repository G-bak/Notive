...
| AI | ai_requests, ai_results, ai_references, prompt_presets, ai_usage_logs |
...
* `organization_id, assignee_user_id, status` index
* `organization_id, team_id, status` index
* `organization_id, due_date` index
